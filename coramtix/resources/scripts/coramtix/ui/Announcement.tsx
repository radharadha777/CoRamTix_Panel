...
import Md2React from '@/coramtix/ui/Md2React';
...
const Announcement = () => {
    const alertType = useStoreState((state: ApplicationStore) => state.coramtix.data!.alertType);
    const alertMessage = useStoreState((state: ApplicationStore) => state.coramtix.data!.alertMessage);
    return (
        <Container>
            {alertType !== 'disabled' ? (
                <AlertContainer
               ...
               ${
                   alertType === 'info'
                       ...
                       ? 'bg-coramtix/10 border-coramtix'
                       : alertType === 'danger'
                ...
                >
                    <div>
                        {alertType === 'info' ? (
                            ...
                            <BellIcon className='h-5 w-5 font-bold !text-coramtix' />
                        ) : alertType === 'danger' ? (
