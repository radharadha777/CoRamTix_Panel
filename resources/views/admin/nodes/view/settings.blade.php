                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-12">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>Change the "<code>container@coramtix~</code>" text.</small></p>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>Change the "<code>[CoRamTix Daemon]:</code>" text.</small></p>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
